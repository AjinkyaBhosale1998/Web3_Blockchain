...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'externalOperation',
        component: ExternalOperationComponent,
        canActivate: [AuthGuard],
        children: [
          {
            path: 'validateNft',
            component: ValidateNftComponent,
            canActivate: [AuthGuard],
          },
        ],
      },
